...
export const DailyReadingInputSchema = z.object({
    ...
    }).describe('The user birth data.'),
    aspects: z.array(z.object({
        planet1: z.string(),
        planet2: z.string(),
        type: z.string(),
        sign1: z.string().optional(),
        sign2: z.string().optional(),
    })).describe('List of current transit aspects to the user natal chart.'),
...
export const DailyReadingOutputSchema = z.object({
    headline: z.string().describe('A mystical and catchy title for the daily reading.'),
    theme: z.string().describe('The main energetic theme of the day (e.g., "Transformación Profunda", "Claridad Mental").'),
    reading: z.string().describe('A personalized, deep, and alchemical interpretation of how the transits affect the user specifically. Avoid generic horoscopes. Use the second person ("Tú").'),
